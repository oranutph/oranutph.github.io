let githubUser = 'oranutph'
let repo = 'oranutph.github.io'
...
async function login() {
    ...
    const response = await fetch('https://script.google.com/macros/s/AKfycbw661HUkji0Id3-8Beij0RXQ3XreTBEAZZJcrliy93w98YK21VePCSL0lIiiyelydms/exec');
